...
export async function getStaticProps({ params }) {
  ...
  projectProps.open_issues = data.open_issues ?? 0;
  projectProps.subscribers_count = data.subscribers_count ?? 0;
  projectProps.stargazers_count = data.stargazers_count ?? 0;

  return { props: { project: projectProps } };
}
